...
public class TransferEvaluationResult{
    ...
    public TransferEvaluationResult(Long id,Double overlapPercentage,Integer creditHourDifference,Boolean isEligibleTransfer,Timestamp evaluatedAt,String notes){
        this.id=id;
